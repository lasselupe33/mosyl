...
/**
 * This is the item provider adapter for a {@link org.mdse.puzzle.Puzzle} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PuzzleItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Puzzle_name_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Puzzle_name_feature", "_UI_Puzzle_type"),
						PuzzlePackage.Literals.PUZZLE__NAME, true, false, false,
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Puzzle_description_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Puzzle_description_feature",
								"_UI_Puzzle_type"),
						PuzzlePackage.Literals.PUZZLE__DESCRIPTION, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addTestsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Puzzle_tests_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Puzzle_tests_feature", "_UI_Puzzle_type"),
						PuzzlePackage.Literals.PUZZLE__TESTS, true, false, true, null, null, null));
	}
	...
	public String getText(Object object) {
		String label = ((Puzzle) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_Puzzle_type")
				: getString("_UI_Puzzle_type") + " " + label;
	}
