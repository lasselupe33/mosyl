...
/**
 * This is the item provider adapter for a {@link org.mdse.constructs.ArithmeticExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArithmeticExpressionItemProvider extends ExpressionItemProvider {
	...
	protected void addExpression2PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_ArithmeticExpression_expression2_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_ArithmeticExpression_expression2_feature",
						"_UI_ArithmeticExpression_type"),
				ConstructsPackage.Literals.ARITHMETIC_EXPRESSION__EXPRESSION2, true, false, true, null, null, null));
	}
	...
	protected void addExpression1PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_ArithmeticExpression_expression1_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_ArithmeticExpression_expression1_feature",
						"_UI_ArithmeticExpression_type"),
				ConstructsPackage.Literals.ARITHMETIC_EXPRESSION__EXPRESSION1, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ConstructsPackage.Literals.ARITHMETIC_EXPRESSION__EXPRESSION2);
			childrenFeatures.add(ConstructsPackage.Literals.ARITHMETIC_EXPRESSION__EXPRESSION1);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(ConstructsPackage.Literals.ARITHMETIC_EXPRESSION__EXPRESSION2,
		...
		newChildDescriptors.add(createChildParameter(ConstructsPackage.Literals.ARITHMETIC_EXPRESSION__EXPRESSION1,
				ConstructsFactory.eINSTANCE.createIntegerVariable()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify = childFeature == ConstructsPackage.Literals.ARITHMETIC_EXPRESSION__EXPRESSION2
				|| childFeature == ConstructsPackage.Literals.ARITHMETIC_EXPRESSION__EXPRESSION1;
