...
public class BooleanLiteralImpl extends LiteralImpl implements BooleanLiteral {
	...
	protected EClass eStaticClass() {
		return ConstructsPackage.Literals.BOOLEAN_LITERAL;
	}
	...
	public void setValue(Boolean newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConstructsPackage.BOOLEAN_LITERAL__VALUE, oldValue,
					value));
	}
