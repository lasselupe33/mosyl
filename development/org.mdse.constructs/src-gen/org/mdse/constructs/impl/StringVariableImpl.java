...
public class StringVariableImpl extends VariableImpl implements StringVariable {
	...
	protected EClass eStaticClass() {
		return ConstructsPackage.Literals.STRING_VARIABLE;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConstructsPackage.STRING_VARIABLE__VALUE, oldValue,
					value));
	}
